...
public class CoreNLP {
   public static void main(String[] Args){
        System.out.println(returnTriplets("Sentinel node biopsy is now also widely used in patients with pathologically positive nodes who receive neoadjuvant chemotherapy."));
    }
...
//        System.out.println(sentences.size());
        ...
        for (Sentence sent : sentences) {  // Will iterate over two sentences
            ...
            for (int i = 0; i < s.toArray().length ; i++) {
                ...
                temp = quad.toString();
                System.out.println("Triplet: "+temp);
...
//            System.out.println("Longest overall: "+longest);
            ...
            acc += shortest+", ";
            System.out.println("Shortest Triplet: "+shortest);
            if(!custom.equals(shortest)){
                acc +=custom+", ";
                System.out.println("Custom Triplet: "+custom);
            }
            if(!longest.equals(custom)){
                acc +=longest;
                System.out.println("Longest Triplet: "+longest);
            }
