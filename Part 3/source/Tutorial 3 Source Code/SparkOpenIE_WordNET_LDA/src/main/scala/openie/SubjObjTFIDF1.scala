...
//      val test = doc._2.replaceAll("\\)\\]", "").replaceAll("\\[\\(", "").replaceAll(":", "").replaceAll("%", "percecnt")
      ...
      val finSen = a.map(sen => {
        val c = sen.replaceAll("\\)\\]", "").replaceAll("\\[\\(", "").replaceAll("\\[", "").replaceAll("\\]", "")
          .replaceAll("%", "percecnt").replaceAll("≥", "greater than or equal to").replaceAll(">","greater than")
